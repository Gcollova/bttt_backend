...
const collect_name_repository_1 = require("./collect_name.repository");
const common_1 = require("@nestjs/common");
let CollectUserService = class CollectUserService {
    constructor() {
        this.collectUserRepo = new collect_name_repository_1.CollectUserRepository();
    }
    async create(user) {
...
//# sourceMappingURL=collect_name.service.js.map